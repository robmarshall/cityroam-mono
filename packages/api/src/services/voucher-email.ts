...
export const VOUCHER_EMAIL_CONTENT: Record<SupportedLanguage, VoucherEmailCopy> = {
  en: {
    ...
    tagline: "City Roam — explore Leeds, guided by the Owl",
    forLabel: "For",
  ...
  es: {
    ...
    tagline: "City Roam — explora Leeds con el Búho como guía",
    forLabel: "Para",
  ...
  fr: {
    ...
    tagline: "City Roam — explorez Leeds, guidés par le Hibou",
    forLabel: "Pour",
  ...
  de: {
    ...
    tagline: "City Roam — Leeds entdecken, geführt von der Eule",
    forLabel: "Für",
  ...
  nl: {
    ...
    tagline: "City Roam — ontdek Leeds, met de Uil als gids",
    forLabel: "Voor",
    codeLabel: "Boncode",
