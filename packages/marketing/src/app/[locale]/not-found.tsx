  ...
  return (
    <main className="flex min-h-[60vh] items-center justify-center bg-white px-6 py-24">
      <div className="mx-auto max-w-lg text-center">
        ...
        <p className="mt-4 text-lg leading-relaxed text-gray-600">{t("description")}</p>
        <Link
          href="/"
          className="mt-10 inline-flex rounded-button bg-brand-600 px-6 py-3 font-semibold text-white transition-colors hover:bg-brand-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
        >
          {t("backHome")}
        </Link>
      </div>
